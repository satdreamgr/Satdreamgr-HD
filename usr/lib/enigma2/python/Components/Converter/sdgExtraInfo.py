...
from Tools.SdgEcmInfo import SdgEcmInfo
...
class sdgExtraInfo(Poll, Converter, object):
	def __init__(self, type):
		...
		self.caid_data = (
			...
			("0x4aee", "0x5581", "BulC",    " BU "),
			( "0xe00",  "0xeff", "PowerVU", " PV "),
			("0x5600", "0x56ff", "VeriMx",  " VM ")
		)
		self.ecmdata = SdgEcmInfo()
	...
	def getBool(self):
		...
		if self.type == "CryptoCaidBetaAvailable":
			request_caid = " B "
			request_selected = False
		elif self.type == "CryptoCaidIrdetoAvailable":
			request_caid = " I "
			request_selected = False
		elif self.type == "CryptoCaidSecaAvailable":
			request_caid = " S "
			request_selected = False
			...
			request_caid = " DC "
			request_selected = False
		elif self.type == "CryptoCaidBulCAvailable":
			request_caid = " BU "
			request_selected = False
		elif self.type == "CryptoCaidPowerVUAvailable":
			request_caid = " PV "
			request_selected = False
		elif self.type == "CryptoCaidVeriMxAvailable":
			request_caid = " VM "
			request_selected = False
			...
			request_caid = " DC "
			request_selected = True
		elif self.type == "CryptoCaidBulCSelected":
			request_caid = " BU "
			request_selected = True
		elif self.type == "CryptoCaidPowerVUSelected":
			request_caid = " PV "
			request_selected = True
		elif self.type == "CryptoCaidVeriMxSelected":
			request_caid = " VM "
			request_selected = True
		else:
			return False
